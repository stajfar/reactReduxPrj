...
//import { selectPatientById } from './eformsSlice';
...
//function PatientSummary({ id }: any) {
...
//    const patient = useSelector((state) => selectPatientById(state, id));//this is fhir patient need to use fhir path to get its details.
